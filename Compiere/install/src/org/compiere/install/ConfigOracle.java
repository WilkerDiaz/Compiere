 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: ConfigOracle.java 7904 2009-07-20 22:22:01Z freyes $
 */
public class ConfigOracle extends Config
{
	...
	public String test()
	{
		...
		if (databaseUser.equalsIgnoreCase("CompiereBVL")){
			error="CompiereBVL is reserved for internal Compiere usage";
			signalOK(getPanel().okDatabaseUser, "ErrorJDBC", false, true, error);
			return error;
		}
