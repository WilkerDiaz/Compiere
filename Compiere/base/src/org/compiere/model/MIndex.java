...
{
    /** Logger for class MIndex */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MIndex.class);
	/**
	 * 
	 */
	...
	public static int cleanUp (Trx trx, int AD_Client_ID, int AD_Table_ID, int Record_ID)
	{
		StringBuffer sb = new StringBuffer ("DELETE FROM K_Index "
			...
			+ "AD_Table_ID= ?  AND "
			+ "Record_ID= ? ");
		Object[] params = new Object[]{AD_Client_ID,AD_Table_ID,Record_ID};
