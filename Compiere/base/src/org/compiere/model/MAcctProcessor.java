...
{
    /** Logger for class MAcctProcessor */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MAcctProcessor.class);
	/**
	 * 
	 */
	...
	public int deleteLog()
	{
		...
		String sql = "DELETE FROM C_AcctProcessorLog "
			+ "WHERE C_AcctProcessor_ID= ? AND addDays(Created,?) < SysDate";
		Object[] params = new Object[]{getC_AcctProcessor_ID(),getKeepLogDays()}; 
