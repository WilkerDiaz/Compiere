...
{
    /** Logger for class MDistributionLine */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MDistributionLine.class);
	/**
	 * 
	 */
	...
	protected boolean beforeSave (boolean newRecord)
	{
		if (getLine() == 0)
		{
			...
			int ii = QueryUtil.getSQLValue (get_Trx(), sql, getGL_Distribution_ID());
			setLine (ii);
		}
