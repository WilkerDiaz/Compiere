...
{
    /** Logger for class MRecurring */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MRecurring.class);
	/**
	 * 
	 */
	...
	public String executeRun()
	{
		...
		if (!calculateRuns())
			throw new CompiereStateException ("No Runs Left");
	...
	private boolean calculateRuns()
	{
		...
		int current = QueryUtil.getSQLValue(get_Trx(), sql, getC_Recurring_ID());
