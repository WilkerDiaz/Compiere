...
public class MRequisition extends X_M_Requisition implements DocAction
{
	...
	public String getDocBaseType() {
		return MDocBaseType.DOCBASETYPE_PurchaseRequisition;
	}
	...
	public QueryParams getLineOrgsQueryInfo() {
		return new QueryParams("SELECT DISTINCT AD_Org_ID FROM M_RequisitionLine WHERE M_Requisition_ID = ?",
