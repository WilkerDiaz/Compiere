...
public class MMeasureCalc extends X_PA_MeasureCalc {
    /** Logger for class MMeasureCalc */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MMeasureCalc.class);
	/**
	 * 
	 */
	...
	public Query getQuery(MGoalRestriction[] restrictions,
		...
		ResultSet rs = null;
		try {
			pstmt = DB.prepareStatement(finalSQL, get_Trx());
