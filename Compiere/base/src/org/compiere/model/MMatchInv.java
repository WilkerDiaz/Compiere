...
{
    /** Logger for class MMatchInv */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MMatchInv.class);
	/**
	 * 
	 */
	...
	protected boolean beforeDelete ()
	{
		if (isPosted())
		{
			String msg = MPeriod.isOpen(getCtx(), getAD_Client_ID(), null, getDateAcct(), MDocBaseType.DOCBASETYPE_MatchInvoice);
			if (msg != null)
			{
				log.warning(msg);
				return false;
