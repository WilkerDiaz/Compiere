...
{
    /** Logger for class MActivity */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MActivity.class);
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		if (!newRecord && (is_ValueChanged("Value") || is_ValueChanged("Name")))
			MAccount.updateValueDescription(getCtx(), "C_Activity_ID= ? ",
					get_Trx(),new Object[]{getC_Activity_ID()});
		return true;
	}	//	afterSave
