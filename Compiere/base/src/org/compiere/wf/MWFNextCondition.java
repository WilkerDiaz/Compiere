...
{
    /** Logger for class MWFNextCondition */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MWFNextCondition.class);
	/**
	 * 
	 */
	...
	public boolean evaluate (MWFActivity activity)
	{
		if (getAD_Column_ID() == 0)
			throw new CompiereStateException("No Column defined - " + this);
			
		PO po = activity.getPO();
		if (po == null || po.get_ID() == 0)
			throw new CompiereStateException("Could not evaluate " + po + " - " + this);
		//
