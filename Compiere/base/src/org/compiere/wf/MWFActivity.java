...
//		System.out.println("EMAIL: "+subject + " " +message );
		...
		else if (recipient.equals("B")) { //Jefe de Categoría
...
//			System.out.println("Comprador");
		...
		else if (recipient.equals("C")) { //Jefe de Categoría
			// ID del Jefe de Categoría correspondiente a la categoría de la OC
...
//			System.out.println("Jefe de Categoría");
			sendEMail(client, id, null, subject, message, pdf);
		}
		
		else if (recipient.equals("P")) { //Jefe de Planificación
...
//				System.out.println("Jefe de Planificacion");
		...
		else if (recipient.equals("L")) { //Gerente de Logística
...
//				System.out.println("Gerente de Logística");
			}
		}
