                        ...
                        <tr>
                            ...
                            <td class="oddRow lineItem">
                                ...
                                <c:if test='${rfq.pdfAttachment}'>
                                    <br>
                                    <a href="rfqServlet/RfQ_<c:out value='${rfq.c_RfQ_ID}'/>.pdf?C_RfQ_ID=<c:out value='${rfq.c_RfQ_ID}'/>" target="_blank"><img src="res/pdf.gif" alt="Get Report" width="30" height="30" border="0"></a>
                                </c:if>
                                <br/>
