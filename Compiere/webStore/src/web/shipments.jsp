...
<div id="main">
	...
	<h2>My Shipments</h2>
      ...
      <table class="contentTable">
        ...
        <tr> 
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${shipment.documentNo}'/></td>
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${shipment.docStatusName}'/></td>
          <td class="<c:out value='${rowClass}' /> left"><fmt:formatDate value='${shipment.movementDate}'/></td>
        </tr>
        </c:forEach> 
      </table>
      <p>&nbsp;</p></div>
