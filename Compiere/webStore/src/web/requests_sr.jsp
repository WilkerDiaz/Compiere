...
<div id="main">
	...
	<h2>Assigned Requests</h2>
      ...
      <table class="contentTable">
        ...
        <tr> 
          <td class="<c:out value='${rowClass}' /> left"><a href="requestDetails.jsp?R_Request_ID=<c:out value='${request.r_Request_ID}'/>&ForwardTo=requests_sr.jsp"><c:out value='${request.documentNo}'/></a></td>
