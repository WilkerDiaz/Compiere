...
<div id="main">
	...
	<div id="content"> 
	  <h2>Info - Interest Areas</h2>
	  <c:if test='${not empty info.info}'>
	    <p><b><c:out value='${info.message}'/></b></p>
	  </c:if>
        <table class="contentTable">
        <tr> 
          	<th class="left">Interest Area</th>
          	<th class="left">Description</th>
          	<th class="left">Subscription</th>
        </tr>
        ...
        <tr> 
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${interest.name}'/></td>
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${interest.description}'/>&nbsp;</td>
