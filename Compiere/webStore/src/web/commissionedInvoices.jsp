	...
	<div id="content">
      ...
      <table class="contentTable">
        ...
        <tr> 
          ...
          <td class="<c:out value='${rowClass}' /> left"><a href="invoiceServlet/I_<c:out value='${invoice.documentNo}'/>.pdf?Invoice_ID=<c:out value='${invoice.c_Invoice_ID}'/>" target="_blank"><img src="res/pdf.gif" alt="Get Invoice Image" width="30" height="30" border="0"></a></td>
          <td class="<c:out value='${rowClass}' /> left"><c:if test='${not invoice.paid}'><b>Not </b></c:if>Paid</td>
        </tr>
        </c:forEach> 
      </table>
      <p>&nbsp;</p>
