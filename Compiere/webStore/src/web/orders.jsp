...
<div id="main">
	...
	<h2>My Orders</h2>
      ...
      <table class="contentTable">
        ...
        <tr> 
          <td class="<c:out value='${rowClass}' /> left"><a href="orderDetails.jsp?C_Order_ID=<c:out value='${order.c_Order_ID}'/>"><c:out value='${order.documentNo}'/></a></td>
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${order.description}'/>&nbsp;</td>
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${order.docStatusName}'/></td>
          <td class="<c:out value='${rowClass}' /> left"><fmt:formatDate value='${order.dateOrdered}'/></td>
