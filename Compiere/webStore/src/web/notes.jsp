...
<div id="main">
	...
	<div id="content">
      ...
      <table class="contentTable">
        <tr> 
          <th class="left">Created Priority</th>
          <th class="left">Workflow Step Description</th>
		...
		<form action="workflowServlet" method="post" enctype="application/x-www-form-urlencoded" name="Activity">
          ...
          <td class="<c:out value='${rowClass}' /> left"><fmt:formatDate value='${act.created}'/><br><i><c:out value='${act.priority}'/></i></td>
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${act.nodeName}'/><br>
          <c:out value='${act.nodeDescription}'/>
          ...
          <td class="<c:out value='${rowClass}' /> left"><c:out value='${act.historyHTML}' escapeXml='false'/></td>
          <td class="<c:out value='${rowClass}' /> left"><textarea name="textMsg" cols="30" rows="3" id="textMsg"></textarea><br>
