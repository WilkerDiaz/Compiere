...
public class ImageElement extends PrintElement
{
	...
	public static ImageElement get (String imageURLString)
	{
		...
		if(image!=null && image.getImage()==null){
			...
			X_AD_Image im = new X_AD_Image( Env.getCtx(), new Integer(imageURLString), null);
			byte[] imageData = im.getBinaryData();
			if (imageData != null){
				Image imageAux = Toolkit.getDefaultToolkit().createImage(imageData);
				return new ImageElement(imageAux, imageURLString);
			}
		}
		//FIN BECO
