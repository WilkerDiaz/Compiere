...
{
    /** Logger for class MPrintFormatItem */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MPrintFormatItem.class);
	/**
	 * 
	 */
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
			...
			&& getPrintName() != null && getPrintName().length() > 0)
		{
			...
			*/
			...
			int no = DB.executeUpdate(get_Trx(), sql, new Object[]{getAD_Column_ID(), get_ID(), getAD_Column_ID(), get_ID()});
