...
/** Generated Model for XX_VLO_Urbanization
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_XX_VLO_Urbanization extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_VLO_Urbanization_ID id
    @param trx transaction
    */
    public X_XX_VLO_Urbanization (Ctx ctx, int XX_VLO_Urbanization_ID, Trx trx)
    {
        super (ctx, XX_VLO_Urbanization_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_VLO_Urbanization_ID == 0)
        {
            setName (null);
            setValue (null);
    ...
    @param trx transaction
    */
    public X_XX_VLO_Urbanization (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27624257228789L;
    /** Last Updated Timestamp 2012-07-12 17:55:12.0 */
    public static final long updatedMS = 1342131912000L;
    /** AD_Table_ID=1000394 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_VLO_Urbanization");
        
    }
    ;
    
    /** TableName=XX_VLO_Urbanization */
    public static final String Table_Name="XX_VLO_Urbanization";
