...
public class MVMR_BudgetSalesDepart extends X_XX_VMR_BudgetSalesDepart{
	
	private static final long serialVersionUID = 1L;
	
	public MVMR_BudgetSalesDepart (Ctx ctx, int ComercialBudget_ID, Trx trx)
	{
...
//			setPackageMultiple (Env.ONE);				///////////////////////////////////////////
	...
	public MVMR_BudgetSalesDepart (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}
