...
/** Generated Model for I_XX_Tabm13
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_I_XX_Tabm13 extends PO
{
    /** Standard Constructor
    @param ctx context
    @param I_XX_Tabm13_ID id
    @param trx transaction
    */
    public X_I_XX_Tabm13 (Ctx ctx, int I_XX_Tabm13_ID, Trx trx)
    {
        super (ctx, I_XX_Tabm13_ID, trx);
    ...
    @param trx transaction
    */
    public X_I_XX_Tabm13 (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27566887991789L;
    /** Last Updated Timestamp 2010-09-17 18:01:15.0 */
    public static final long updatedMS = 1284762675000L;
    /** AD_Table_ID=1000064 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("I_XX_Tabm13");
        
    }
    ;
    
    /** TableName=I_XX_Tabm13 */
    public static final String Table_Name="I_XX_Tabm13";
    ...
    /** Set I_XX_TABM13_ID.
    @param I_XX_TABM13_ID I_XX_TABM13_ID */
    public void setI_XX_TABM13_ID (int I_XX_TABM13_ID)
    {
        if (I_XX_TABM13_ID < 1) throw new IllegalArgumentException ("I_XX_TABM13_ID is mandatory.");
        set_ValueNoCheck ("I_XX_TABM13_ID", Integer.valueOf(I_XX_TABM13_ID));
        
    }
    
    /** Get I_XX_TABM13_ID.
    @return I_XX_TABM13_ID */
    public int getI_XX_TABM13_ID() 
    {
        return get_ValueAsInt("I_XX_TABM13_ID");
    ...
    @param XX_DesLin Descripción de línea */
    public void setXX_DesLin (String XX_DesLin)
    {
        set_Value ("XX_DesLin", XX_DesLin);
        
    }
    
    /** Get Description line.
    @return Descripción de línea */
    public String getXX_DesLin() 
    {
        return (String)get_Value("XX_DesLin");
        
    }
    
    /** Set Status line.
    @param XX_EstLin Estatus de línea */
    public void setXX_EstLin (String XX_EstLin)
    {
        set_Value ("XX_EstLin", XX_EstLin);
        
    }
    
    /** Get Status line.
    @return Estatus de línea */
    public String getXX_EstLin() 
    {
        return (String)get_Value("XX_EstLin");
