...
//			setPackageMultiple (Env.ONE);				///////////////////////////////////////////
	...
	{	
		...
		/*El campo de comprador solo puede ser modificado por el jefe de categoría del departamemto o Gerente de Merchandising */
		if(getXX_UserBuyer_ID() != get_ValueOldAsInt("XX_UserBuyer_ID")){
			...
			if(user.getC_BPartner_ID() != category.getXX_CategoryManager_ID() && Env.getCtx().getContextAsInt("#XX_L_ROLEMERCHANDISING_ID")!= Env.getCtx().getContextAsInt("#AD_Role_ID") ){
				ADialog.error(1, new Container(), "El campo de comprador solo puede ser modificado por el jefe de categoría del departamemto o Gerente de Merchandising." );
				return false;
			}
		}
