 ...
 *  para el tipo de distribucion por reposición
 *  (modificación de código de Javier Pino para distribuciones completas)
 *  @author Gabrielle Huchet
 */
public class XX_ReplacementDetail extends XX_DistributionDetail {
	...
	public XX_ReplacementDetail(int detalleID, Ctx contexto, Trx trxNombre, int mes, int año) {
	...
	public void inicializar()  {
		...
		presupuesto = new XX_BudgetDetail(super.detalle.get_ID(), ctx, nombreTrx, mes, año);
