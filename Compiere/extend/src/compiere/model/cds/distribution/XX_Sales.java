...
/**
 *  Clase concreta que almacena los métodos de distribucion para el tipo de distribucion por ventas
 *  @author Javier Pino
 */
public class XX_Sales extends XX_Distribution  {
	...
	public XX_Sales(int cabeceraID, Ctx contexto, Trx trxNombre, int mes, int año) {
