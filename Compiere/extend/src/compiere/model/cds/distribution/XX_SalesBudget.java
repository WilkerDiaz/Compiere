...
/**
 *  Clase concreta que almacena los métodos de distribucion para el tipo de distribucion por presupuesto
 *  @author Javier Pino
 */
public class XX_SalesBudget extends XX_Distribution  {
	...
	public XX_SalesBudget(int cabeceraID, Ctx contexto, Trx trxNombre, int mes, int año, boolean ventasPasadas) {
	...
	public void inicializar()  {
		...
		presupuesto = new XX_Budget(cabecera.get_ID(), ctx, nombreTrx, mes, año);
		...
		//Inicializar presupuesto usando clase hermana XX_Budget
		ventas = new XX_Sales(cabecera.get_ID(), ctx, nombreTrx, mesVentas, añoVentas);
		ventas.inicializar();
