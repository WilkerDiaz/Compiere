...
public class XXVMRPOProductDistribCallout extends CalloutEngine {
	...
	public String PriceCallout (Ctx ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
		...
		if (mField.getColumnName().equals("XX_Margin") ) {
			...
			BigDecimal  SaleUnitCost = ((BigDecimal)mTab.getValue("PriceActual")).divide(new BigDecimal(unidad_compra), RoundingMode.HALF_UP).multiply(new BigDecimal(unidad_venta));
