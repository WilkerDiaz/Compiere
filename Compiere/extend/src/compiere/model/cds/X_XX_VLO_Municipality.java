...
/** Generated Model for XX_VLO_Municipality
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_XX_VLO_Municipality extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_VLO_Municipality_ID id
    @param trx transaction
    */
    public X_XX_VLO_Municipality (Ctx ctx, int XX_VLO_Municipality_ID, Trx trx)
    {
        super (ctx, XX_VLO_Municipality_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_VLO_Municipality_ID == 0)
        {
            setC_City_ID (0);
            setName (null);
            setValue (null);
    ...
    @param trx transaction
    */
    public X_XX_VLO_Municipality (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27581053274789L;
    /** Last Updated Timestamp 2011-02-28 16:49:18.0 */
    public static final long updatedMS = 1298927958000L;
    /** AD_Table_ID=1000391 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_VLO_Municipality");
        
    }
    ;
    
    /** TableName=XX_VLO_Municipality */
    public static final String Table_Name="XX_VLO_Municipality";
