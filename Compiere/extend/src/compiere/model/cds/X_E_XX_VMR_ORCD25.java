...
/** Generated Model for E_XX_VMR_ORCD25
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_E_XX_VMR_ORCD25 extends PO
{
    /** Standard Constructor
    @param ctx context
    @param E_XX_VMR_ORCD25_ID id
    @param trx transaction
    */
    public X_E_XX_VMR_ORCD25 (Ctx ctx, int E_XX_VMR_ORCD25_ID, Trx trx)
    {
        super (ctx, E_XX_VMR_ORCD25_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (E_XX_VMR_ORCD25_ID == 0)
        {
            setE_XX_VMR_ORCD25_ID (0);
            setValue (null);
    ...
    @param trx transaction
    */
    public X_E_XX_VMR_ORCD25 (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27573198654789L;
    /** Last Updated Timestamp 2010-11-29 18:58:58.0 */
    public static final long updatedMS = 1291073338000L;
    /** AD_Table_ID=1000348 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("E_XX_VMR_ORCD25");
        
    }
    ;
    
    /** TableName=E_XX_VMR_ORCD25 */
    public static final String Table_Name="E_XX_VMR_ORCD25";
    ...
    /** Set CANREG.
    @param CANREG GIF QUANTITY */
    public void setCANREG (int CANREG)
    {
        set_Value ("CANREG", Integer.valueOf(CANREG));
    ...
    /** Set E_XX_VMR_ORCD25_ID.
    @param E_XX_VMR_ORCD25_ID E_XX_VMR_ORCD25_ID */
    public void setE_XX_VMR_ORCD25_ID (int E_XX_VMR_ORCD25_ID)
    {
        if (E_XX_VMR_ORCD25_ID < 1) throw new IllegalArgumentException ("E_XX_VMR_ORCD25_ID is mandatory.");
        set_ValueNoCheck ("E_XX_VMR_ORCD25_ID", Integer.valueOf(E_XX_VMR_ORCD25_ID));
        
    }
    
    /** Get E_XX_VMR_ORCD25_ID.
    @return E_XX_VMR_ORCD25_ID */
    public int getE_XX_VMR_ORCD25_ID() 
    {
        return get_ValueAsInt("E_XX_VMR_ORCD25_ID");
