...
public class ImportBudgetAs400 extends SvrProcess {
	...
	protected String doIt() throws Exception {
        ...
        {          
			...
			while (rs.next())
			{
				...
				"XX_MONVENREA = "+rs.getString(31)+"," + 
				"XX_CANVENREA = "+rs.getString(32)+"," +  
				...
				tablaCompiere.setXX_AÑOMESPRE(rs.getInt(6));
