 ...
 * @author Javier Pino
 * */
public class XX_DistributionOCPiecesProcess extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		if(header.isXX_AutoAdjustment()){
			ADialog.info(1, new Container(),Msg.getMsg(getCtx(), "XX_AutoAdjustmentDistPieces"));
			return "";
