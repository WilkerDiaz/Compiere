...
public class ImportInventoryForDateAs400 extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		ResultSet rs = null;
		String sql = "select * from becofile.invm14 where mesinv=" + (date.get(Calendar.MONTH) + 1); //+" and a—oinv="+(fecha.getYear()+1900)   ;	
        try
        {          
