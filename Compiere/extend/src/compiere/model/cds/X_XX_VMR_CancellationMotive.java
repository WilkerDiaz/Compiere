...
/** Generated Model for XX_VMR_CancellationMotive
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_XX_VMR_CancellationMotive extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_VMR_CancellationMotive_ID id
    @param trx transaction
    */
    public X_XX_VMR_CancellationMotive (Ctx ctx, int XX_VMR_CancellationMotive_ID, Trx trx)
    {
        super (ctx, XX_VMR_CancellationMotive_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_VMR_CancellationMotive_ID == 0)
        {
            setName (null);
    ...
    @param trx transaction
    */
    public X_XX_VMR_CancellationMotive (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27550955409789L;
    /** Last Updated Timestamp 2010-03-17 08:18:13.0 */
    public static final long updatedMS = 1268830093000L;
    /** AD_Table_ID=1000136 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_VMR_CancellationMotive");
        
    }
    ;
    
    /** TableName=XX_VMR_CancellationMotive */
    public static final String Table_Name="XX_VMR_CancellationMotive";
    ...
    public void setXX_VMR_CancellationMotive_ID (int XX_VMR_CancellationMotive_ID)
    {
        ...
        set_ValueNoCheck ("XX_VMR_CancellationMotive_ID", Integer.valueOf(XX_VMR_CancellationMotive_ID));
