...
public class XX_PrintProductLabelsForm extends CPanel
	...
	private void sendMailToBuyer() throws SQLException {
		...
		//Busco el correo del Comprador y el nombre y código del proveedor de la Orden de Compra
		...
		String subject = "Impresión de Etiquetas Despacho Directo"; 
		String msg = " Han sido impresas las etiquetas de precio correspondiente a la Orden de Compra Nro. " + C_Order_ID + 
				", de proveedor "+ c_bpartner + ". Favor dirigirse al Área de Chequeo para retirarlas.";
		if(emailTo.contains("@")){
