 ...
 *
 */
public class XX_DistributionOCSalesBudget_Form extends CPanel 
	...
	private X_XX_VMR_DistributionHeader distributionHeader = null;
	...
	public void init(int WindowNo, FormFrame frame) {
		...
		Integer headerID  = Env.getCtx().getContextAsInt("#XX_VMR_SalesBudget_DistributionHeader_ID");
		
		//Creates the Header with the necessary information
		distributionHeader = new X_XX_VMR_DistributionHeader(Env.getCtx(), headerID, null);
	...
	public void generarDistribucion(){
		...
		if (XX_PercentualDistribution.applyPOPercentualDistribution(
				distributionHeader,	percentagesDePino, codesDePino, m_WindowNo, m_frame,0)) {						
			dispose();
		}
	}	//	generarDistribucion
