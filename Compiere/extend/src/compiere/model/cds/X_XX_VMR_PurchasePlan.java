...
/** Generated Model for XX_VMR_PurchasePlan
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_XX_VMR_PurchasePlan extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_VMR_PurchasePlan_ID id
    @param trx transaction
    */
    public X_XX_VMR_PurchasePlan (Ctx ctx, int XX_VMR_PurchasePlan_ID, Trx trx)
    {
        super (ctx, XX_VMR_PurchasePlan_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_VMR_PurchasePlan_ID == 0)
        {
    ...
    @param trx transaction
    */
    public X_XX_VMR_PurchasePlan (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27564371794789L;
    /** Last Updated Timestamp 2010-08-19 15:04:38.0 */
    public static final long updatedMS = 1282246478000L;
    /** AD_Table_ID=1000333 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_VMR_PurchasePlan");
        
    }
    ;
    
    /** TableName=XX_VMR_PurchasePlan */
    public static final String Table_Name="XX_VMR_PurchasePlan";
