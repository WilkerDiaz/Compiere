...
public class X_XX_VCN_ISLRRetention extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27607386753789L;
    /** Last Updated Timestamp 2011-12-30 11:40:37.0 */
    public static final long updatedMS = 1325261437000L;
    /** AD_Table_ID=1000512 */
    ...
    /** Set XX_ISLRCODE.
    @param XX_ISLRCODE XX_ISLRCODE */
    public void setXX_ISLRCODE (String XX_ISLRCODE)
    {
        set_Value ("XX_ISLRCODE", XX_ISLRCODE);
        
    }
    
    /** Get XX_ISLRCODE.
    @return XX_ISLRCODE */
    public String getXX_ISLRCODE() 
    {
        return (String)get_Value("XX_ISLRCODE");
    ...
    public static final String XX_TYPEPERSONISLR_PNR_PERSONANATURALVENEZOLANO = X_Ref_XX_Ref_TypePersonISLR.PN_R__PERSONANATURALVENEZOLANO.getValue();
    ...
    public void setXX_TypePersonISLR (String XX_TypePersonISLR)
    {
        ...
        throw new IllegalArgumentException ("XX_TypePersonISLR Invalid value - " + XX_TypePersonISLR + " - Reference_ID=1000429 - PJD - PJND - PNNR - PNR");
