...
/** Generated Model for XX_PROMOMASIVAS
 *  @author Jorg Janke (generated) 
 *  @version Release 3.6.2 - $Id: GenerateModel.java 8952 2010-06-16 07:52:26Z ragrawal $ */
public class X_XX_PROMOMASIVAS extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_PROMOMASIVAS_ID id
    @param trx transaction
    */
    public X_XX_PROMOMASIVAS (Ctx ctx, int XX_PROMOMASIVAS_ID, Trx trx)
    {
        super (ctx, XX_PROMOMASIVAS_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_PROMOMASIVAS_ID == 0)
        {
            setXX_CATEGORIA_ID (0);
            setXX_PROMOCIONES_ID (0);
            setXX_PROMOMASIVAS_ID (0);
    ...
    @param trx transaction
    */
    public X_XX_PROMOMASIVAS (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27525149955789L;
    /** Last Updated Timestamp 2009-05-22 16:07:19.0 */
    public static final long updatedMS = 1243024639000L;
    /** AD_Table_ID=1000010 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_PROMOMASIVAS");
        
    }
    ;
    
    /** TableName=XX_PROMOMASIVAS */
    public static final String Table_Name="XX_PROMOMASIVAS";
    ...
    {
        set_Value ("Seccion", Integer.valueOf(Seccion));
    ...
    /** Set XX_PROMOMASIVAS_ID.
    @param XX_PROMOMASIVAS_ID XX_PROMOMASIVAS_ID */
    public void setXX_PROMOMASIVAS_ID (int XX_PROMOMASIVAS_ID)
    {
        if (XX_PROMOMASIVAS_ID < 1) throw new IllegalArgumentException ("XX_PROMOMASIVAS_ID is mandatory.");
        set_ValueNoCheck ("XX_PROMOMASIVAS_ID", Integer.valueOf(XX_PROMOMASIVAS_ID));
        
    }
    
    /** Get XX_PROMOMASIVAS_ID.
    @return XX_PROMOMASIVAS_ID */
    public int getXX_PROMOMASIVAS_ID() 
    {
        return get_ValueAsInt("XX_PROMOMASIVAS_ID");
