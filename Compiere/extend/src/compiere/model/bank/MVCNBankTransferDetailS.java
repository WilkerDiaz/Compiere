...
public class MVCNBankTransferDetailS extends X_XX_VCN_BankTransferDetailS{
	
	public MVCNBankTransferDetailS(Ctx ctx, int XX_VCN_BankTransferDetailS_ID,
			Trx trx) {
	 ...
	 */
	public MVCNBankTransferDetailS (Ctx ctx, ResultSet rs, Trx trx)
	{
		super(ctx, rs, trx);
	}
	...
	/*
	 * SI ELIMINO ACTUALIZO EL MONTO TOTAL DE LA TRANSFERENCIA BANCARIA
	 */
