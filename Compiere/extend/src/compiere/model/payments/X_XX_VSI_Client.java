...
public class X_XX_VSI_Client extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27601245595789L;
    /** Last Updated Timestamp 2011-10-20 09:47:59.0 */
    public static final long updatedMS = 1319120279000L;
    /** AD_Table_ID=1000409 */
    ...
    /** Set Cedula/RIF.
    @param XX_CI_RIF Cedula o RIF del Proveedor */
    ...
    /** Get Cedula/RIF.
    @return Cedula o RIF del Proveedor */
    ...
    public void setXX_Nit (int XX_Nit)
    {
        set_Value ("XX_Nit", Integer.valueOf(XX_Nit));
        
    }
    
    /** Get NIT.
    @return NIT del Proveedor */
    public int getXX_Nit() 
    {
        return get_ValueAsInt("XX_Nit");
