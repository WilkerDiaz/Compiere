...
/**
 * Detalle de los traspasos
 * @author Jessica Mendoza
 *
 */
public class XX_DetailsTransfers extends CPanel
...
private static final long serialVersionUID = 1L;
	...
	private TitledBorder xBorder =
		new TitledBorder(Msg.getMsg(Env.getCtx(), "XX_DetailTransfers"));
	...
	private void jbInit() throws Exception{
		...
		totalGeneralLabel.setText(Msg.getMsg(Env.getCtx(), "XX_TotalTransfers"));   
