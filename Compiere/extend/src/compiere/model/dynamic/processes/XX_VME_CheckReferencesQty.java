 ...
 * 
 */
public class XX_VME_CheckReferencesQty extends SvrProcess{
	...
	protected String doIt() throws Exception {
		...
		Date fin = new Date();
		System.out.println("Eliminar del folleto referencias con inventario cero: "+inicio+" final: "+fin);
		return msj;
	} // doIt
...
//		System.out.println("AM: "+activity.getName()+" Elemento: "+elemento.getName()+ " referencia: "+reference.getName()+" "+SQLProds.length());
	...
	public void processElements(Vector<Integer> elements, Vector<Integer> actions, 
		...
		X_XX_VMA_MarketingActivity activity = null;
		if(elements.size()!=0){
			int elementoAnterior = elements.elementAt(0);   
