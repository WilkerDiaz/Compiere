...
public class X_XX_ProductName extends PO
{
    ...
    */
    public X_XX_ProductName (Ctx ctx, int XX_ProductName_ID, Trx trx)
    {
        super (ctx, XX_ProductName_ID, trx);
    ...
    @param trx transaction
    */
    public X_XX_ProductName (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27620515549789L;
    /** Last Updated Timestamp 2012-05-30 10:33:53.0 */
    public static final long updatedMS = 1338390233000L;
    /** AD_Table_ID=1002458 */
    ...
    /** Set Product Name (ByS).
    @param XX_ProductName_ID Product Name for products of assets and services */
    ...
    /** Get Product Name (ByS).
    @return Product Name for products of assets and services */
