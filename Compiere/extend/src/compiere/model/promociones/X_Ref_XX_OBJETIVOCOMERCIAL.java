...
public enum X_Ref_XX_OBJETIVOCOMERCIAL 
{
    ...
    private X_Ref_XX_OBJETIVOCOMERCIAL(String value)
    {
         this.value = value;
    ...
    public static boolean isValid(String test) 
    {
         ...
         for( X_Ref_XX_OBJETIVOCOMERCIAL v : X_Ref_XX_OBJETIVOCOMERCIAL.values())
        {
