...
/** XX_TypePromotion AD_Reference_ID=1000013 */
public enum X_Ref_XX_TypePromotion 
{
    ...
    private X_Ref_XX_TypePromotion(String value)
    {
         this.value = value;
    ...
    public static boolean isValid(String test) 
    {
         ...
         for( X_Ref_XX_TypePromotion v : X_Ref_XX_TypePromotion.values())
        {
