...
/** XX_CommercialObjetive AD_Reference_ID=1000012 */
public enum X_Ref_XX_OBJETICOCOMERCIAL 
{
    ...
    public static final int AD_Reference_ID=1000012;
    private final String value;
    private X_Ref_XX_OBJETICOCOMERCIAL(String value)
    {
         this.value = value;
    ...
    public static boolean isValid(String test) 
    {
         ...
         for( X_Ref_XX_OBJETICOCOMERCIAL v : X_Ref_XX_OBJETICOCOMERCIAL.values())
        {
