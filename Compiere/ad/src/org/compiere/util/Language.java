 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: Language.java 9191 2010-08-17 08:25:25Z ragrawal $
 */
public class Language implements Serializable
{
	...
	private static void setUIManagerValues()
	{
		if(Ini.isClient())
		{
			UIManager.put("FileChooser.cancelButtonText", Msg.getMsg(s_loginLanguage,"CancelOnly"));
			UIManager.put("FileChooser.openButtonText", Msg.getMsg(s_loginLanguage,"Open"));
			UIManager.put("FileChooser.saveButtonText", Msg.getMsg(s_loginLanguage,"SaveOnly"));
			UIManager.put("FileChooser.lookInLabelText", Msg.getMsg(s_loginLanguage,"LookIn"));
			UIManager.put("FileChooser.filesOfTypeLabelText", Msg.getMsg(s_loginLanguage,"FileType"));
			UIManager.put("FileChooser.fileNameLabelText", Msg.getMsg(s_loginLanguage,"FileName")); 
			UIManager.put("FileChooser.saveInLabelText", Msg.getMsg(s_loginLanguage,"SaveIn"));
		}
	}
