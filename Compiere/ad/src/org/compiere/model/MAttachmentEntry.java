 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MAttachmentEntry.java 8288 2009-12-17 23:58:10Z gwu $
 */
public class MAttachmentEntry
{
    /** Logger for class MAttachmentEntry */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MAttachmentEntry.class);
	/**
	 * 	Get Data from URI
	 *	@param uri uri
	 *	@return data or null
