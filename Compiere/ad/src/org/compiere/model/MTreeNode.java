 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MTreeNode.java 8755 2010-05-12 18:30:14Z nnayak $
 */
public class MTreeNode extends X_AD_TreeNode
{
    /** Logger for class MTreeNode */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MTreeNode.class);
	/**
	 * 
	 */
