 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: MTreeNodeMM.java 8755 2010-05-12 18:30:14Z nnayak $
 */
public class MTreeNodeMM extends X_AD_TreeNodeMM
{
    /** Logger for class MTreeNodeMM */
    private static final org.compiere.util.CLogger log = org.compiere.util.CLogger.getCLogger(MTreeNodeMM.class);
	/**
	 * 
	 */
