 ...
 *  @version Release 3.5.1 Dev - $Id: X_I_Forecast.java 8247 2009-12-08 15:26:09Z gwu $ */
public class X_I_Forecast extends PO
{
    /** Standard Constructor
    @param ctx context
    @param I_Forecast_ID id
    @param trx transaction
    */
    public X_I_Forecast (Ctx ctx, int I_Forecast_ID, Trx trx)
    {
        super (ctx, I_Forecast_ID, trx);
    ...
    @param trx transaction
    */
    public X_I_Forecast (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
    ...
    /** AD_Table_ID=2102 */
    public static final int Table_ID=2102;
    ...
    /** Set I_Forecast_ID.
    @param I_Forecast_ID Identifies a forecast */
    public void setI_Forecast_ID (int I_Forecast_ID)
    {
        if (I_Forecast_ID < 1) throw new IllegalArgumentException ("I_Forecast_ID is mandatory.");
        set_ValueNoCheck ("I_Forecast_ID", Integer.valueOf(I_Forecast_ID));
        
    }
    
    /** Get I_Forecast_ID.
    @return Identifies a forecast */
    public int getI_Forecast_ID() 
    {
        return get_ValueAsInt("I_Forecast_ID");
    ...
    {
        if (MRP_ForecastLine_ID <= 0) set_Value ("MRP_ForecastLine_ID", null);
        else
        set_Value ("MRP_ForecastLine_ID", Integer.valueOf(MRP_ForecastLine_ID));
    ...
    {
        if (MRP_Forecast_ID <= 0) set_Value ("MRP_Forecast_ID", null);
        else
        set_Value ("MRP_Forecast_ID", Integer.valueOf(MRP_Forecast_ID));
