 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: TranslationTable.java 8780 2010-05-19 23:08:57Z nnayak $
 */
public class TranslationTable
{
	...
	public boolean createTranslation (PO po)
	{
		...
		int no = DB.executeUpdate(po.get_Trx(), sql.toString());
	...
	public boolean resetTranslationFlag (PO po)
	{
		...
		int no = DB.executeUpdate(po.get_Trx(), sb.toString());
		log.fine(m_trlTableName + ": ID=" + po.get_ID() + " #" + no);
		return no != 0;
