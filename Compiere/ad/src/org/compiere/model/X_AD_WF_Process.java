 ...
 *  @version Release 3.5.1 Dev - $Id: X_AD_WF_Process.java 8247 2009-12-08 15:26:09Z gwu $ */
public class X_AD_WF_Process extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27526020663789L;
    /** Last Updated Timestamp 2009-06-01 15:29:07.0 */
    public static final long updatedMS = 1243895347000L;
    /** AD_Table_ID=645 */
    ...
    {
        if (AD_WorkflowProcessor_ID <= 0) set_ValueNoCheck ("AD_WorkflowProcessor_ID", null);
        else
    ...
    @param DateActualStart Actual Start Date */
    public void setDateActualStart (Timestamp DateActualStart)
    {
        set_ValueNoCheck ("DateActualStart", DateActualStart);
        
    }
    
    /** Get Actual Start Date.
    @return Actual Start Date */
    public Timestamp getDateActualStart() 
    {
        return (Timestamp)get_Value("DateActualStart");
        
    }
    
    /** Set Finish Date.
    @param DateFinished Finish Date */
    public void setDateFinished (Timestamp DateFinished)
    {
        set_ValueNoCheck ("DateFinished", DateFinished);
    ...
    {
        return (Timestamp)get_Value("DateFinished");
    ...
    {
        throw new IllegalArgumentException ("DateNextRun is virtual column");
    ...
    @param DateScheduledStart Scheduled Start Date */
    public void setDateScheduledStart (Timestamp DateScheduledStart)
    {
        set_Value ("DateScheduledStart", DateScheduledStart);
        
    }
    
    /** Get Scheduled Start Date.
    @return Scheduled Start Date */
    public Timestamp getDateScheduledStart() 
    {
        return (Timestamp)get_Value("DateScheduledStart");
    ...
    /** <None> = -- */
    public static final String REQUESTDOCACTION_None = X_Ref__Document_Action.NONE.getValue();
    /** Approve = AP */
    public static final String REQUESTDOCACTION_Approve = X_Ref__Document_Action.APPROVE.getValue();
    /** Close = CL */
    public static final String REQUESTDOCACTION_Close = X_Ref__Document_Action.CLOSE.getValue();
    /** Complete = CO */
    public static final String REQUESTDOCACTION_Complete = X_Ref__Document_Action.COMPLETE.getValue();
    /** Invalidate = IN */
    public static final String REQUESTDOCACTION_Invalidate = X_Ref__Document_Action.INVALIDATE.getValue();
    /** Post = PO */
    public static final String REQUESTDOCACTION_Post = X_Ref__Document_Action.POST.getValue();
    /** Prepare = PR */
    public static final String REQUESTDOCACTION_Prepare = X_Ref__Document_Action.PREPARE.getValue();
    /** Reverse - Accrual = RA */
    public static final String REQUESTDOCACTION_Reverse_Accrual = X_Ref__Document_Action.REVERSE__ACCRUAL.getValue();
    /** Reverse - Correct = RC */
    public static final String REQUESTDOCACTION_Reverse_Correct = X_Ref__Document_Action.REVERSE__CORRECT.getValue();
    /** Re-activate = RE */
    public static final String REQUESTDOCACTION_Re_Activate = X_Ref__Document_Action.RE__ACTIVATE.getValue();
    /** Reject = RJ */
    public static final String REQUESTDOCACTION_Reject = X_Ref__Document_Action.REJECT.getValue();
    /** Void = VO */
    public static final String REQUESTDOCACTION_Void = X_Ref__Document_Action.VOID.getValue();
    /** Wait Complete = WC */
    public static final String REQUESTDOCACTION_WaitComplete = X_Ref__Document_Action.WAIT_COMPLETE.getValue();
    /** Unlock = XL */
    public static final String REQUESTDOCACTION_Unlock = X_Ref__Document_Action.UNLOCK.getValue();
    /** Set Request Document Action.
    @param RequestDocAction The targeted status of the document */
    public void setRequestDocAction (String RequestDocAction)
    {
        if (!X_Ref__Document_Action.isValid(RequestDocAction))
        throw new IllegalArgumentException ("RequestDocAction Invalid value - " + RequestDocAction + " - Reference_ID=135 - -- - AP - CL - CO - IN - PO - PR - RA - RC - RE - RJ - VO - WC - XL");
        set_ValueNoCheck ("RequestDocAction", RequestDocAction);
        
    }
    
    /** Get Request Document Action.
    @return The targeted status of the document */
    public String getRequestDocAction() 
    {
        return (String)get_Value("RequestDocAction");
