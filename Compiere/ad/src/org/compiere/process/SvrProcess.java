 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: SvrProcess.java 8776 2010-05-19 17:50:56Z nnayak $
 */
...
//			+ m_pi.getAD_PInstance_ID(), (Trx) null);		//	outside p_trx
		DB.executeUpdate(null, "UPDATE AD_PInstance SET IsProcessing='Y' WHERE AD_PInstance_ID=?", new Integer[] { new Integer(m_pi.getAD_PInstance_ID())});
	}   //  lock
