 ...
 *
 *  @author     Jorg Janke
 *  @version    $Id: ProcessInfo.java 8244 2009-12-04 23:25:29Z freyes $
 */
public class ProcessInfo implements Serializable
{
	...
	/** Scheduled Start Date for Background Processes */
	private Timestamp			m_DateScheduledStart = null;
	...
	//SR 10021318: If large report, return multiple PDF's		
	private ArrayList<String> m_files = new ArrayList<String>(5);

	public ArrayList<String> getFiles() {
		return m_files;
	}

	public void setFiles(ArrayList<String> m_files) {
	...
	{
		return m_batch || m_DateScheduledStart != null;
	}	//	isBatch
	...
	public Timestamp getDateScheduledStart() {
		return m_DateScheduledStart;
	}

	public void setDateScheduledStart(Timestamp dateScheduledStart) {
		m_DateScheduledStart = dateScheduledStart;
	}	
}   //  ProcessInfo
