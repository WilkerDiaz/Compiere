 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CompiereMonitor.java 8615 2010-04-09 21:55:17Z sraval $
 */
...
//		line.addElement(new td().addElement(system.getDBInstance()));
		...
		// JDBC Cache Info
		line = new tr();
		line.addElement(new th().addElement("JDBC Cache "));
		String[] jdbcCacheMessages = db.getJDBCCacheInfo();
		line.addElement(new td().addElement(new String(jdbcCacheMessages[0])));
		table.addElement(line);
		//	Runtime
		line = new tr();
