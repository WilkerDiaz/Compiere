 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: FactLine.java 8780 2010-05-19 23:08:57Z nnayak $
 */
public final class FactLine extends X_Fact_Acct
{
	...
	/** Logger */
	private static CLogger log = CLogger.getCLogger(FactLine.class);
	...
	public boolean setAmtSource (int C_Currency_ID, BigDecimal AmtSourceDr, BigDecimal AmtSourceCr)
	{
		...
		if (getAmtSourceDr().signum()==0 && getAmtSourceCr().signum()==0)
			return false;
		//	Currency Precision
	...
	public int getC_SalesRegion_ID ()
	{
		...
		if (m_doc != null)
		{
			...
			//	&& m_acctSchema.isAcctSchemaElement(MAcctSchemaElement.ELEMENTTYPE_SalesRegion))
			{
				...
				setC_SalesRegion_ID (QueryUtil.getSQLValue(get_Trx(),
